...
DEFAULT_MLX_SUBDIR = "mlx/gemma-3-4b-it-mlx"
DEFAULT_ADAPTER_SUBDIR = "adapters/gemma3-4b-it-chembl-toon"
DEFAULT_MODEL_NAME = "chembl-drug-chat:gemma3-4b"
...
def export_to_ollama(
    ...
    Args:
        ...
        model_name:     Ollama model name to create (e.g. ``chembl-drug-chat:gemma3-4b``).
    ...
    # (mlx_lm --export-gguf does not support the Gemma 3 export path we use here,
